...
c = [person.name for person in humans if person.name[0] in included_letters]
print(c)
...
# --> fails test...i think it needs to look like original list, not f
# --> "error: doesn't contain name ... "
